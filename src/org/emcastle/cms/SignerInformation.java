...
import org.emcastle.asn1.cms.SignerIdentifier;
...
import org.emcastle.cms.jcajce.JcaSignerInfoVerifierBuilder;
...
import org.emcastle.operator.RawContentVerifier;
...
public class SignerInformation
{
        ...
        throws CMSException, NoSuchAlgorithmException
    {
        try
        {
            ...
            if (sigProvider != null)
            {
                if (!sigProvider.getName().equalsIgnoreCase("EM"))
                {
     ...
     * @throws org.emcastle.cms.CMSVerifierCertificateNotValidException if the provider has an associated certificate and the certificate is not valid at the time given as the SignerInfo's signing time.
     * @throws org.emcastle.cms.CMSException if the verifier is unable to create a ContentVerifiers or DigestCalculators.
     */
