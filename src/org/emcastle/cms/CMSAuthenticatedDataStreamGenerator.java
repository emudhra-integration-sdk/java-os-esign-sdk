...
import org.emcastle.asn1.cms.AuthenticatedData;
import org.emcastle.asn1.cms.CMSObjectIdentifiers;
import org.emcastle.asn1.x509.AlgorithmIdentifier;
import org.emcastle.cms.jcajce.JceCMSMacCalculatorBuilder;
 ...
 *
 *      edGen.addRecipientInfoGenerator(new JceKeyTransRecipientInfoGenerator(cert).setProvider("EM"));
 *
 *      ByteArrayOutputStream  bOut = new ByteArrayOutputStream();
 *
 *      OutputStream out = edGen.open(
 *                              bOut, new JceCMSMacCalculatorBuilder(CMSAlgorithm.DES_EDE3_CBC).setProvider("EM").build());*
 *      out.write(data);
 *
 *      out.close();
 * </pre>
