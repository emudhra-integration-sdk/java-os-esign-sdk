...
import org.emcastle.asn1.cms.SignedData;
import org.emcastle.asn1.cms.SignerInfo;
import org.emcastle.cert.jcajce.JcaCertStoreBuilder;
import org.emcastle.operator.DefaultSignatureAlgorithmIdentifierFinder;
 ...
 *  
 *      if (signer.verify(new JcaSimpleSignerInfoVerifierBuilder().setProvider("EM").build(cert)))
 *      {
 *          verified++;
 *      }   
 *  }
...
public class CMSSignedData
{
     ...
     * @deprecated use base Store returning method and org.emcastle.cert.jcajce.JcaCertStoreBuilder
     */
