...
import org.emcastle.cms.jcajce.JceCMSContentEncryptorBuilder;
 ...
 *
 *      edGen.addRecipientInfoGenerator(new JceKeyTransRecipientInfoGenerator(recipientCert).setProvider("EM"));
 *
 *      ByteArrayOutputStream  bOut = new ByteArrayOutputStream();
 *      
 *      OutputStream out = edGen.open(
 *                              bOut, new JceCMSContentEncryptorBuilder(CMSAlgorithm.DES_EDE3_CBC)
 *                                              .setProvider("EM").build());
 *      out.write(data);
 *      
 *      out.close();
 * </pre>
