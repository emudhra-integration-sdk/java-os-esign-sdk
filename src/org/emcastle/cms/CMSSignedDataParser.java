...
import org.emcastle.asn1.ASN1Generator;
import org.emcastle.asn1.ASN1ObjectIdentifier;
import org.emcastle.asn1.ASN1OctetStringParser;
import org.emcastle.asn1.ASN1SequenceParser;
import org.emcastle.asn1.ASN1Set;
import org.emcastle.asn1.ASN1SetParser;
import org.emcastle.asn1.ASN1StreamParser;
import org.emcastle.asn1.BERSequenceGenerator;
import org.emcastle.asn1.BERSetParser;
import org.emcastle.asn1.BERTaggedObject;
import org.emcastle.asn1.BERTags;
import org.emcastle.asn1.DERSet;
import org.emcastle.asn1.DERTaggedObject;
import org.emcastle.asn1.cms.CMSObjectIdentifiers;
import org.emcastle.asn1.cms.ContentInfoParser;
import org.emcastle.asn1.cms.SignedDataParser;
import org.emcastle.asn1.cms.SignerInfo;
import org.emcastle.asn1.x509.AlgorithmIdentifier;
import org.emcastle.cert.jcajce.JcaCertStoreBuilder;
...
import org.emcastle.x509.NoSuchStoreException;
 ...
 * </p>
 * <pre>
 *      CMSSignedDataParser     sp = new CMSSignedDataParser(new JcaDigestCalculatorProviderBuilder().setProvider("EM").build(), encapSigData);
 *
 ...
 *
 *          System.out.println("verify returns: " + signer.verify(new JcaSimpleSignerInfoVerifierBuilder().setProvider("EM").build(cert)));
 *      }
 * </pre>
    ...
    extends CMSContentInfoParser
{
     ...
     * @throws org.emcastle.x509.NoSuchStoreException if the store type isn't available.
     ...
     * @deprecated use getCertificates() and org.emcastle.cert.jcajce.JcaCertStoreBuilder
     */
