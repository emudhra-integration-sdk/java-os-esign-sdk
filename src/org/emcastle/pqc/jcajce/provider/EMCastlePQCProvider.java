package org.emcastle.pqc.jcajce.provider;
...
public class EMCastlePQCProvider
    extends Provider
    implements ConfigurableProvider
{
    private static String info = "emCastle Post-Quantum Security Provider v1.48";

    public static String PROVIDER_NAME = "EMPQC";
    ...
    */
    private static final String ALGORITHM_PACKAGE = "org.emcastle.pqc.jcajce.provider.";
