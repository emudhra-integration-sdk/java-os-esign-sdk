...
import org.emcastle.asn1.pkcs.EncryptionScheme;
import org.emcastle.asn1.pkcs.KeyDerivationFunc;
import org.emcastle.asn1.pkcs.PBEParameter;
...
import org.emcastle.crypto.generators.OpenSSLPBEParametersGenerator;
import org.emcastle.crypto.generators.PKCS5S2ParametersGenerator;
import org.emcastle.crypto.params.KeyParameter;
import org.emcastle.jce.ECNamedCurveTable;
import org.emcastle.jce.PKCS10CertificationRequest;
import org.emcastle.util.encoders.Hex;
import org.emcastle.util.io.pem.PemHeader;
import org.emcastle.util.io.pem.PemObject;
import org.emcastle.util.io.pem.PemObjectParser;
import org.emcastle.util.io.pem.PemReader;
import org.emcastle.x509.X509V2AttributeCertificate;
        ...
        extends KeyPairParser
    {
            ...
            throws IOException
        {
            try
            {
                ...
                org.emcastle.asn1.sec.ECPrivateKey pKey = org.emcastle.asn1.sec.ECPrivateKey.getInstance(seq);
        ...
        extends KeyPairParser
    {
            ...
            throws IOException
        {
            try
            {
                ...
                org.emcastle.asn1.pkcs.RSAPrivateKey keyStruct = org.emcastle.asn1.pkcs.RSAPrivateKey.getInstance(seq);
