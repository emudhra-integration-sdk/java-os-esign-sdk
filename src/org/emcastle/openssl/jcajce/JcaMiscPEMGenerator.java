...
import org.emcastle.cert.jcajce.JcaX509AttributeCertificateHolder;
...
import org.emcastle.openssl.MiscPEMGenerator;
    ...
    extends MiscPEMGenerator
{
        ...
        throws IOException
    {
        ...
        {
            return new org.emcastle.pkcs.PKCS10CertificationRequest(((PKCS10CertificationRequest)o).getEncoded());
        }
