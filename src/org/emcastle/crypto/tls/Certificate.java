 ...
 * </pre>
 *
 * @see org.emcastle.asn1.x509.Certificate
 */
public class Certificate
{

    public static final Certificate EMPTY_CHAIN = new Certificate(
        new org.emcastle.asn1.x509.Certificate[0]);

    protected org.emcastle.asn1.x509.Certificate[] certificateList;

    public Certificate(org.emcastle.asn1.x509.Certificate[] certificateList)
    {
     ...
     */
    public org.emcastle.asn1.x509.Certificate[] getCerts()
    {
        return clone(certificateList);
    }

    /**
     * @return an array of {@link org.emcastle.asn1.x509.Certificate} representing a certificate
     *         chain.
     */
    public org.emcastle.asn1.x509.Certificate[] getCertificateList()
    {
        return clone(certificateList);
    }

    public org.emcastle.asn1.x509.Certificate getCertificateAt(int index)
    {
    ...
    public static Certificate parse(InputStream input)
        throws IOException
    {
        org.emcastle.asn1.x509.Certificate[] certs;
        ...
        while (left > 0)
        {
            ...
            tmp.addElement(org.emcastle.asn1.x509.Certificate.getInstance(asn1));
        }
        certs = new org.emcastle.asn1.x509.Certificate[tmp.size()];
        for (int i = 0; i < tmp.size(); i++)
        {
            certs[i] = (org.emcastle.asn1.x509.Certificate)tmp.elementAt(i);
        }
        return new Certificate(certs);
    }

    private org.emcastle.asn1.x509.Certificate[] clone(org.emcastle.asn1.x509.Certificate[] list)
    {
        org.emcastle.asn1.x509.Certificate[] rv = new org.emcastle.asn1.x509.Certificate[list.length];
