...
import org.emcastle.asn1.x509.Holder;
import org.emcastle.asn1.x509.IssuerSerial;
import org.emcastle.asn1.x509.ObjectDigestInfo;
 ...
 *          }
 * </pre>
 * @deprecated use org.emcastle.cert.AttributeCertificateHolder
 */
    ...
    implements CertSelector, Selector
{
    ...
    {
        holder = new org.emcastle.asn1.x509.Holder(new IssuerSerial(
    ...
    public boolean match(Certificate cert)
    {
        ...
        try
        {
            ...
            if (holder.getObjectDigestInfo() != null)
            {
                ...
                try
                {
                    md = MessageDigest.getInstance(getDigestAlgorithm(), "EM");
