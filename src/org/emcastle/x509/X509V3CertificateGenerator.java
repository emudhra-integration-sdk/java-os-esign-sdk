...
import org.emcastle.asn1.x509.TBSCertificate;
import org.emcastle.asn1.x509.Time;
import org.emcastle.asn1.x509.V3TBSCertificateGenerator;
...
import org.emcastle.jce.provider.X509CertificateObject;
import org.emcastle.x509.extension.X509ExtensionUtil;

/**
 * class to produce an X.509 Version 3 certificate.
 *  @deprecated use org.emcastle.cert.X509v3CertificateBuilder.
 */
public class X509V3CertificateGenerator
{
        ...
        throws SecurityException, SignatureException, InvalidKeyException
    {
        try
        {
            return generateX509Certificate(key, "EM", null);
        }
    ...
    /**
     * generate an X509 certificate, based on the current issuer and subject
     * using the default provider "EM", and the passed in source of randomness
     * (if required).
        ...
        throws SecurityException, SignatureException, InvalidKeyException
    {
        try
        {
            return generateX509Certificate(key, "EM", random);
        }
        catch (NoSuchProviderException e)
        {
            throw new SecurityException("EM provider not installed!");
