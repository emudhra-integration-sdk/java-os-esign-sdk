...
import org.emcastle.asn1.ASN1GeneralizedTime;
...
import org.emcastle.asn1.x509.CertificateList;
import org.emcastle.asn1.x509.Extensions;
import org.emcastle.asn1.x509.TBSCertList;
import org.emcastle.asn1.x509.Time;
import org.emcastle.asn1.x509.V2TBSCertListGenerator;
import org.emcastle.asn1.x509.X509Extensions;
import org.emcastle.asn1.x509.X509ExtensionsGenerator;
import org.emcastle.asn1.x509.X509Name;
import org.emcastle.jce.X509Principal;
import org.emcastle.jce.provider.X509CRLObject;

/**
 * class to produce an X.509 Version 2 CRL.
 *  @deprecated use org.emcastle.cert.X509v2CRLBuilder.
 */
public class X509V2CRLGenerator
{
     ...
     * using the default provider "EM".
     * @deprecated use generate(key, "EM")
     */
        ...
        throws SecurityException, SignatureException, InvalidKeyException
    {
        try
        {
            return generateX509CRL(key, "EM", null);
        }
        catch (NoSuchProviderException e)
        {
            throw new SecurityException("EM provider not installed!");
        }
    }

    /**
     * generate an X509 CRL, based on the current issuer and subject
     * using the default provider "EM" and an user defined SecureRandom object as
     * source of randomness.
     * @deprecated use generate(key, random, "EM")
     */
    public X509CRL generateX509CRL(
        PrivateKey      key,
        SecureRandom    random)
        throws SecurityException, SignatureException, InvalidKeyException
    {
        try
        {
            return generateX509CRL(key, "EM", random);
        }
        catch (NoSuchProviderException e)
        {
            throw new SecurityException("EM provider not installed!");
