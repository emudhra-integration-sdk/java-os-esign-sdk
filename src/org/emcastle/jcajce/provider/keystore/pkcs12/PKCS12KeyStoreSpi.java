package org.emcastle.jcajce.provider.keystore.pkcs12;
...
import org.emcastle.asn1.BEROctetString;
import org.emcastle.asn1.BEROutputStream;
import org.emcastle.asn1.DERBMPString;
...
import org.emcastle.asn1.pkcs.AuthenticatedSafe;
import org.emcastle.asn1.pkcs.CertBag;
import org.emcastle.asn1.pkcs.ContentInfo;
import org.emcastle.asn1.pkcs.EncryptedData;
import org.emcastle.asn1.pkcs.MacData;
...
import org.emcastle.asn1.pkcs.Pfx;
import org.emcastle.asn1.pkcs.SafeBag;
import org.emcastle.asn1.util.ASN1Dump;
import org.emcastle.asn1.x509.AlgorithmIdentifier;
import org.emcastle.asn1.x509.AuthorityKeyIdentifier;
import org.emcastle.asn1.x509.DigestInfo;
import org.emcastle.asn1.x509.Extension;
import org.emcastle.asn1.x509.SubjectKeyIdentifier;
import org.emcastle.asn1.x509.SubjectPublicKeyInfo;
import org.emcastle.asn1.x509.X509ObjectIdentifiers;
import org.emcastle.jcajce.provider.config.PKCS12StoreParameter;
import org.emcastle.jcajce.provider.symmetric.util.BCPBEKey;
import org.emcastle.jcajce.provider.util.SecretKeyUtil;
import org.emcastle.jce.interfaces.BCKeyStore;
import org.emcastle.jce.interfaces.PKCS12BagAttributeCarrier;
import org.emcastle.jce.provider.emCastleProvider;
import org.emcastle.jce.provider.JDKPKCS12StoreParameter;
    ...
    implements PKCSObjectIdentifiers, X509ObjectIdentifiers, BCKeyStore
{
    ...
    private static final Provider bcProvider = new emCastleProvider();
            ...
            for (int i = 0; i != c.length; i++)
            {
                if (c[i].getContentType().equals(data))
                {
                    ...
                    for (int j = 0; j != seq.size(); j++)
                    {
                        ...
                        {
                            org.emcastle.asn1.pkcs.EncryptedPrivateKeyInfo eIn = org.emcastle.asn1.pkcs.EncryptedPrivateKeyInfo.getInstance(b.getBagValue());
                ...
                else if (c[i].getContentType().equals(encryptedData))
                {
                    ...
                    for (int j = 0; j != seq.size(); j++)
                    {
                        ...
                        {
                            org.emcastle.asn1.pkcs.PrivateKeyInfo kInfo = org.emcastle.asn1.pkcs.PrivateKeyInfo.getInstance(b.getBagValue());
                            PrivateKey privKey = emCastleProvider.getPrivateKey(kInfo);
        ...
        throws IOException
    {
        ...
        while (ks.hasMoreElements())
        {
            ...
            org.emcastle.asn1.pkcs.EncryptedPrivateKeyInfo kInfo = new org.emcastle.asn1.pkcs.EncryptedPrivateKeyInfo(kAlgId, kBytes);
