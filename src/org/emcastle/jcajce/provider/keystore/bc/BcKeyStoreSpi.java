package org.emcastle.jcajce.provider.keystore.bc;
...
import org.emcastle.crypto.PBEParametersGenerator;
import org.emcastle.crypto.digests.SHA1Digest;
import org.emcastle.crypto.generators.PKCS12ParametersGenerator;
import org.emcastle.crypto.io.DigestInputStream;
import org.emcastle.crypto.io.DigestOutputStream;
import org.emcastle.crypto.io.MacInputStream;
import org.emcastle.crypto.io.MacOutputStream;
...
import org.emcastle.util.io.TeeOutputStream;
    ...
    implements BCKeyStore
{
        ...
        throws IOException
    {
        ...
        try
        {
            CertificateFactory cFact = CertificateFactory.getInstance(type, emCastleProvider.PROVIDER_NAME);
        ...
        throws IOException
    {
        ...
        try
        {
            ...
            {
            case KEY_PRIVATE:
                return KeyFactory.getInstance(algorithm, emCastleProvider.PROVIDER_NAME).generatePrivate(spec);
            case KEY_PUBLIC:
                return KeyFactory.getInstance(algorithm, emCastleProvider.PROVIDER_NAME).generatePublic(spec);
            case KEY_SECRET:
                return SecretKeyFactory.getInstance(algorithm, emCastleProvider.PROVIDER_NAME).generateSecret(spec);
            default:
        ...
        throws IOException
    {
        try
        {
            ...
            SecretKeyFactory    keyFact = SecretKeyFactory.getInstance(algorithm, emCastleProvider.PROVIDER_NAME);
            PBEParameterSpec    defParams = new PBEParameterSpec(salt, iterationCount);

            Cipher cipher = Cipher.getInstance(algorithm, emCastleProvider.PROVIDER_NAME);
