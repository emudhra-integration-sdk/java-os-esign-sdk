package org.emcastle.jcajce.provider.config;
 ...
 * Examples:
 * <ul>
 * <li>ProviderConfigurationPermission("EM"); // enable all permissions</li>
 * <li>ProviderConfigurationPermission("EM", "threadLocalEcImplicitlyCa"); // enable thread local only</li>
 * <li>ProviderConfigurationPermission("EM", "ecImplicitlyCa"); // enable global setting only</li>
 * <li>ProviderConfigurationPermission("EM", "threadLocalEcImplicitlyCa, ecImplicitlyCa"); // enable both explicitly</li>
 * </ul>
 * <p>
