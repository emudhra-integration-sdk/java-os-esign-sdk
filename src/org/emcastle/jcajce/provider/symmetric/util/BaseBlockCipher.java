...
import org.emcastle.crypto.OutputLengthException;
import org.emcastle.crypto.modes.AEADBlockCipher;
import org.emcastle.crypto.modes.CBCBlockCipher;
import org.emcastle.crypto.modes.CCMBlockCipher;
import org.emcastle.crypto.modes.CFBBlockCipher;
import org.emcastle.crypto.modes.CTSBlockCipher;
import org.emcastle.crypto.modes.EAXBlockCipher;
import org.emcastle.crypto.modes.GCMBlockCipher;
import org.emcastle.crypto.modes.GOFBBlockCipher;
import org.emcastle.crypto.modes.OCBBlockCipher;
import org.emcastle.crypto.modes.OFBBlockCipher;
import org.emcastle.crypto.modes.OpenPGPCFBBlockCipher;
import org.emcastle.crypto.modes.PGPCFBBlockCipher;
import org.emcastle.crypto.modes.SICBlockCipher;
import org.emcastle.crypto.paddings.BlockCipherPadding;
import org.emcastle.crypto.paddings.ISO10126d2Padding;
import org.emcastle.crypto.paddings.ISO7816d4Padding;
import org.emcastle.crypto.paddings.PaddedBufferedBlockCipher;
import org.emcastle.crypto.paddings.TBCPadding;
import org.emcastle.crypto.paddings.X923Padding;
import org.emcastle.crypto.paddings.ZeroBytePadding;
...
import org.emcastle.crypto.params.ParametersWithSBox;
import org.emcastle.crypto.params.RC2Parameters;
import org.emcastle.crypto.params.RC5Parameters;
import org.emcastle.jce.provider.emCastleProvider;
import org.emcastle.jce.spec.GOST28147ParameterSpec;
import org.emcastle.jce.spec.RepeatedSecretKeySpec;
import org.emcastle.util.Strings;
    ...
    implements PBE
{
    ...
    protected BaseBlockCipher(
        org.emcastle.crypto.BlockCipher engine,
        int ivLength)
    {
        baseEngine = engine;
    ...
    protected AlgorithmParameters engineGetParameters()
    {
        if (engineParams == null)
        {
            if (pbeSpec != null)
            {
                try
                {
                    engineParams = AlgorithmParameters.getInstance(pbeAlgorithm, emCastleProvider.PROVIDER_NAME);
            ...
            else if (ivParam != null)
            {
                ...
                try
                {
                    engineParams = AlgorithmParameters.getInstance(name, emCastleProvider.PROVIDER_NAME);
    ...
    static private interface GenericBlockCipher
    {
        ...
        public org.emcastle.crypto.BlockCipher getUnderlyingCipher();
        ...
        implements GenericBlockCipher
    {
        ...
        BufferedGenericBlockCipher(org.emcastle.crypto.BlockCipher cipher)
        {
            this.cipher = new PaddedBufferedBlockCipher(cipher);
        }

        BufferedGenericBlockCipher(org.emcastle.crypto.BlockCipher cipher, BlockCipherPadding padding)
        {
