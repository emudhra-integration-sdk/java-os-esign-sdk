...
import org.emcastle.crypto.engines.RC2WrapEngine;
...
import org.emcastle.jcajce.provider.symmetric.util.BaseAlgorithmParameters;
...
import org.emcastle.jcajce.provider.symmetric.util.PBESecretKeyFactory;
        ...
        extends BaseAlgorithmParameterGenerator
    {
        ...
        protected AlgorithmParameters engineGenerateParameters()
        {
            ...
            if (spec == null)
            {
                ...
                try
                {
                    params = AlgorithmParameters.getInstance("RC2", emCastleProvider.PROVIDER_NAME);
