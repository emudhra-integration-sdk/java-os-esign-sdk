...
import org.emcastle.asn1.misc.IDEACBCPar;
import org.emcastle.crypto.CipherKeyGenerator;
import org.emcastle.crypto.engines.IDEAEngine;
...
public final class IDEA
{
        ...
        extends BaseAlgorithmParameterGenerator
    {
        ...
        protected AlgorithmParameters engineGenerateParameters()
        {
            ...
            try
            {
                params = AlgorithmParameters.getInstance("IDEA", emCastleProvider.PROVIDER_NAME);
