package org.emcastle.jcajce.provider.asymmetric.x509;
...
import org.emcastle.asn1.misc.MiscObjectIdentifiers;
import org.emcastle.asn1.misc.NetscapeCertType;
import org.emcastle.asn1.misc.NetscapeRevocationURL;
import org.emcastle.asn1.misc.VerisignCzagExtension;
import org.emcastle.asn1.util.ASN1Dump;
import org.emcastle.asn1.x500.X500Name;
import org.emcastle.asn1.x500.style.RFC4519Style;
...
import org.emcastle.asn1.x509.KeyUsage;
...
import org.emcastle.jce.provider.RFC3280CertPathUtilities;
...
{
    private org.emcastle.asn1.x509.Certificate    c;
    ...
    public X509CertificateObject(
        org.emcastle.asn1.x509.Certificate    c)
    ...
    {
        Provider    prov = Security.getProvider(emCastleProvider.PROVIDER_NAME);
    ...
    public PublicKey getPublicKey()
    {
        try
        {
            return emCastleProvider.getPublicKey(c.getSubjectPublicKeyInfo());
        }
        catch (IOException e)
        {
        ...
        InvalidKeyException, NoSuchProviderException, SignatureException
    {
        ...
        try
        {
            signature = Signature.getInstance(sigName, emCastleProvider.PROVIDER_NAME);
        }
        catch (Exception e)
        {
