...
import org.emcastle.asn1.x509.CRLNumber;
    ...
    extends X509CRL
{
    ...
    {
        verify(key, emCastleProvider.PROVIDER_NAME);
    }
            ...
            for (int i = 0; i < certs.length; i++)
            {
                ...
                if (certs[i].getUserCertificate().getValue().equals(serial))
                {
                    ...
                    else
                    {
                        try
                        {
                            issuer = org.emcastle.asn1.x509.Certificate.getInstance(cert.getEncoded()).getIssuer();
                        }
