...
import org.emcastle.crypto.engines.DESedeEngine;
import org.emcastle.crypto.engines.IESEngine;
import org.emcastle.crypto.generators.ECKeyPairGenerator;
import org.emcastle.crypto.generators.EphemeralKeyPairGenerator;
import org.emcastle.crypto.generators.KDF2BytesGenerator;
import org.emcastle.crypto.macs.HMac;
...
import org.emcastle.crypto.params.ECKeyParameters;
import org.emcastle.crypto.params.ECPublicKeyParameters;
import org.emcastle.crypto.params.IESParameters;
import org.emcastle.crypto.params.IESWithCipherParameters;
import org.emcastle.crypto.parsers.ECIESPublicKeyParser;
import org.emcastle.jcajce.provider.asymmetric.util.ECUtil;
import org.emcastle.jcajce.provider.asymmetric.util.IESUtil;
import org.emcastle.jce.interfaces.ECKey;
import org.emcastle.jce.interfaces.ECPrivateKey;
import org.emcastle.jce.interfaces.ECPublicKey;
import org.emcastle.jce.interfaces.IESKey;
import org.emcastle.jce.provider.emCastleProvider;
import org.emcastle.jce.spec.IESParameterSpec;
    ...
    extends CipherSpi
{
    ...
    public AlgorithmParameters engineGetParameters()
    {
        if (engineParam == null && engineSpec != null)
        {
            try
            {
                engineParam = AlgorithmParameters.getInstance("IES", emCastleProvider.PROVIDER_NAME);
