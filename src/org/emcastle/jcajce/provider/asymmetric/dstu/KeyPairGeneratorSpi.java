...
import org.emcastle.crypto.generators.DSTU4145KeyPairGenerator;
    ...
    extends java.security.KeyPairGenerator
{
        ...
        throws InvalidAlgorithmParameterException
    {
        ...
        else if (params == null && emCastleProvider.CONFIGURATION.getEcImplicitlyCa() != null)
        {
            ECParameterSpec p = emCastleProvider.CONFIGURATION.getEcImplicitlyCa();
            this.ecParams = params;
