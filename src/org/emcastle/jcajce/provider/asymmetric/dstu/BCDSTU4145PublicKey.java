package org.emcastle.jcajce.provider.asymmetric.dstu;
...
import org.emcastle.asn1.ua.DSTU4145BinaryField;
import org.emcastle.asn1.ua.DSTU4145ECBinary;
import org.emcastle.asn1.ua.DSTU4145NamedCurves;
import org.emcastle.asn1.ua.DSTU4145Params;
import org.emcastle.asn1.ua.DSTU4145PointEncoder;
import org.emcastle.asn1.ua.UAObjectIdentifiers;
...
import org.emcastle.asn1.x9.X9IntegerConverter;
...
import org.emcastle.jcajce.provider.asymmetric.util.EC5Util;
import org.emcastle.jcajce.provider.asymmetric.util.ECUtil;
import org.emcastle.jcajce.provider.asymmetric.util.KeyUtil;
import org.emcastle.jce.interfaces.ECPointEncoder;
import org.emcastle.jce.provider.emCastleProvider;
import org.emcastle.jce.spec.ECNamedCurveParameterSpec;
import org.emcastle.jce.spec.ECNamedCurveSpec;
import org.emcastle.math.ec.ECCurve;

public class BCDSTU4145PublicKey
    implements ECPublicKey, org.emcastle.jce.interfaces.ECPublicKey, ECPointEncoder
{
    ...
    private transient org.emcastle.math.ec.ECPoint q;
    ...
    public BCDSTU4145PublicKey(
        org.emcastle.jce.spec.ECPublicKeySpec spec)
    {
        this.q = spec.getQ();
        ...
        else
        {
            if (q.getCurve() == null)
            {
                org.emcastle.jce.spec.ECParameterSpec s = emCastleProvider.CONFIGURATION.getEcImplicitlyCa();
    ...
    public BCDSTU4145PublicKey(
        String algorithm,
        ECPublicKeyParameters params,
        org.emcastle.jce.spec.ECParameterSpec spec)
    {
        ECDomainParameters dp = params.getParameters();
    ...
    private void populateFromPubKeyInfo(SubjectPublicKeyInfo info)
    {
        if (info.getAlgorithm().getAlgorithm().equals(UAObjectIdentifiers.dstu4145be) || info.getAlgorithm().getAlgorithm().equals(UAObjectIdentifiers.dstu4145le))
        {
            ...
            org.emcastle.jce.spec.ECParameterSpec spec = null;
            ...
            else
            {
                ...
                spec = new org.emcastle.jce.spec.ECParameterSpec(curve, DSTU4145PointEncoder.decodePoint(curve, g_bytes), binary.getN());
            }
        ...
        else
        {
            ...
            {
                ecSpec = null;
                curve = emCastleProvider.CONFIGURATION.getEcImplicitlyCa().getCurve();
            }
            else
            {
    ...
    public org.emcastle.jce.spec.ECParameterSpec getParameters()
    {
    ...
    public org.emcastle.math.ec.ECPoint getQ()
    {
        if (ecSpec == null)
        {
            if (q instanceof org.emcastle.math.ec.ECPoint.Fp)
            {
                return new org.emcastle.math.ec.ECPoint.Fp(null, q.getX(), q.getY());
            }
            else
            {
                return new org.emcastle.math.ec.ECPoint.F2m(null, q.getX(), q.getY());
            }
        }
    ...
    public org.emcastle.math.ec.ECPoint engineGetQ()
    {
        return q;
    }

    org.emcastle.jce.spec.ECParameterSpec engineGetSpec()
    {
        if (ecSpec != null)
        {
            return EC5Util.convertSpec(ecSpec, withCompression);
        ...
        return emCastleProvider.CONFIGURATION.getEcImplicitlyCa();
    }
