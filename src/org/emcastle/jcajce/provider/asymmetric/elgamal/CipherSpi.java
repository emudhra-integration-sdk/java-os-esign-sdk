package org.emcastle.jcajce.provider.asymmetric.elgamal;
...
import org.emcastle.crypto.BufferedAsymmetricBlockCipher;
...
import org.emcastle.crypto.encodings.ISO9796d1Encoding;
import org.emcastle.crypto.encodings.OAEPEncoding;
import org.emcastle.crypto.encodings.PKCS1Encoding;
import org.emcastle.crypto.engines.ElGamalEngine;
import org.emcastle.crypto.params.ParametersWithRandom;
import org.emcastle.jcajce.provider.asymmetric.util.BaseCipherSpi;
import org.emcastle.jcajce.provider.util.DigestFactory;
import org.emcastle.jce.interfaces.ElGamalKey;
import org.emcastle.jce.interfaces.ElGamalPrivateKey;
import org.emcastle.jce.interfaces.ElGamalPublicKey;
    ...
    protected AlgorithmParameters engineGetParameters() 
    {
        if (engineParams == null)
        {
            if (paramSpec != null)
            {
                try
                {
                    engineParams = AlgorithmParameters.getInstance("OAEP", emCastleProvider.PROVIDER_NAME);
