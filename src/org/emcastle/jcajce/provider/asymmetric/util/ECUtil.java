package org.emcastle.jcajce.provider.asymmetric.util;
...
import org.emcastle.jcajce.provider.asymmetric.ec.BCECPublicKey;
...
public class ECUtil
{
        ...
        throws InvalidKeyException
    {
        if (key instanceof ECPublicKey)
        {
            ...
            if (s == null)
            {
                s = emCastleProvider.CONFIGURATION.getEcImplicitlyCa();
        ...
        else
        {
            ...
            try
            {
                ...
                PublicKey publicKey = emCastleProvider.getPublicKey(SubjectPublicKeyInfo.getInstance(bytes));
        ...
        throws InvalidKeyException
    {
        ...
        else
        {
            ...
            try
            {
                ...
                PrivateKey privateKey = emCastleProvider.getPrivateKey(PrivateKeyInfo.getInstance(bytes));
