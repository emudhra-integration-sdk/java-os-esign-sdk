...
import org.emcastle.crypto.signers.ECGOST3410Signer;
...
import org.emcastle.jce.interfaces.GOST3410Key;
import org.emcastle.jce.provider.emCastleProvider;
import org.emcastle.jcajce.provider.asymmetric.util.GOST3410Util;
        ...
        throws InvalidKeyException
    {
        ...
        else
        {
            try
            {
                ...
                publicKey = emCastleProvider.getPublicKey(SubjectPublicKeyInfo.getInstance(bytes));
