package org.emcastle.jcajce.provider.asymmetric.dsa;
    ...
    implements PKCSObjectIdentifiers, X509ObjectIdentifiers
{
        ...
        extends DSASigner
    {
        public stdDSA()
        {
            super(new SHA1Digest(), new org.emcastle.crypto.signers.DSASigner());
        }
    }
        ...
        extends DSASigner
    {
        public dsa224()
        {
            super(new SHA224Digest(), new org.emcastle.crypto.signers.DSASigner());
        }
    }
        ...
        extends DSASigner
    {
        public dsa256()
        {
            super(new SHA256Digest(), new org.emcastle.crypto.signers.DSASigner());
        }
    }
        ...
        extends DSASigner
    {
        public dsa384()
        {
            super(new SHA384Digest(), new org.emcastle.crypto.signers.DSASigner());
        }
    }
        ...
        extends DSASigner
    {
        public dsa512()
        {
            super(new SHA512Digest(), new org.emcastle.crypto.signers.DSASigner());
        }
    }
        ...
        extends DSASigner
    {
        public noneDSA()
        {
            super(new NullDigest(), new org.emcastle.crypto.signers.DSASigner());
        }
    }
}
