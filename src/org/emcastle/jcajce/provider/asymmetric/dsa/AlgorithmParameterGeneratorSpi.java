...
import org.emcastle.crypto.generators.DSAParametersGenerator;
import org.emcastle.crypto.params.DSAParameterGenerationParameters;
    ...
    extends java.security.AlgorithmParameterGeneratorSpi
{
    ...
    protected AlgorithmParameters engineGenerateParameters()
    {
        ...
        try
        {
            params = AlgorithmParameters.getInstance("DSA", emCastleProvider.PROVIDER_NAME);
