...
//    }
    ...
    public static class F2m extends ECPoint
    {
        ...
        /* (non-Javadoc)
         * @see org.emcastle.math.ec.ECPoint#getEncoded()
         */
        public byte[] getEncoded(boolean compressed)
        {
            if (this.isInfinity()) 
...
//            ECFieldElement.F2m.checkFieldElements(a.x, b.x);
        ...
        /* (non-Javadoc)
         * @see org.emcastle.math.ec.ECPoint#add(org.emcastle.math.ec.ECPoint)
         */
        public ECPoint add(ECPoint b)
        {
            checkPoints(this, b);
        ...
        /* (non-Javadoc)
         * @see org.emcastle.math.ec.ECPoint#subtract(org.emcastle.math.ec.ECPoint)
         */
        public ECPoint subtract(ECPoint b)
        {
            checkPoints(this, b);
        ...
        /* (non-Javadoc)
         * @see org.emcastle.math.ec.ECPoint#twice()
         */
        public ECPoint twice()
        {
            if (this.isInfinity()) 
