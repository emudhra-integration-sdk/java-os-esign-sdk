package org.emcastle.jce.examples;
...
import org.emcastle.jce.PrincipalUtil;
...
import org.emcastle.x509.X509V1CertificateGenerator;
import org.emcastle.x509.X509V3CertificateGenerator;
import org.emcastle.x509.extension.AuthorityKeyIdentifierStructure;
import org.emcastle.x509.extension.SubjectKeyIdentifierStructure;
...
public class PKCS12Example
{
        ...
        throws Exception
    {
        ...
        attrs.put(X509Principal.EmailAddress, "feedback-crypto@example.org");
        ...
        throws Exception
    {
        ...
        sAttrs.put(X509Principal.EmailAddress, "feedback-crypto@example.org");
        ...
        throws Exception
    {
        ...
        // set up the keys
        //
        KeyFactory          fact = KeyFactory.getInstance("RSA", "EM");
        ...
        //
        KeyStore store = KeyStore.getInstance("PKCS12", "EM");
