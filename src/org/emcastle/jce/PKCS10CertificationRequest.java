...
import org.emcastle.asn1.nist.NISTObjectIdentifiers;
import org.emcastle.asn1.oiw.OIWObjectIdentifiers;
import org.emcastle.asn1.pkcs.CertificationRequest;
import org.emcastle.asn1.pkcs.CertificationRequestInfo;
import org.emcastle.asn1.pkcs.PKCSObjectIdentifiers;
import org.emcastle.asn1.pkcs.RSASSAPSSparams;
import org.emcastle.asn1.teletrust.TeleTrusTObjectIdentifiers;
import org.emcastle.asn1.x509.AlgorithmIdentifier;
import org.emcastle.asn1.x509.SubjectPublicKeyInfo;
import org.emcastle.asn1.x509.X509Name;
    ...
    extends CertificationRequest
{
    ...
    /**
     * create a PKCS10 certfication request using the EM provider.
     */
    public PKCS10CertificationRequest(
    ...
    {
        this(signatureAlgorithm, subject, key, attributes, signingKey, emCastleProvider.PROVIDER_NAME);
    }
    ...
    public PKCS10CertificationRequest(
        ...
        throws NoSuchAlgorithmException, NoSuchProviderException,
                InvalidKeyException, SignatureException
    {
        this(signatureAlgorithm, convertName(subject), key, attributes, signingKey, emCastleProvider.PROVIDER_NAME);
    }
     ...
     * the public key is created using the EM provider.
     */
    public PublicKey getPublicKey()
        throws NoSuchAlgorithmException, NoSuchProviderException, InvalidKeyException
    {
        return getPublicKey(emCastleProvider.PROVIDER_NAME);
    }
    ...
    /**
     * verify the request using the EM provider.
     */
    public boolean verify()
        throws NoSuchAlgorithmException, NoSuchProviderException,
                InvalidKeyException, SignatureException
    {
        return verify(emCastleProvider.PROVIDER_NAME);
    }
