        ...
        throws IllegalArgumentException, NoSuchAlgorithmException
    {
        try
        {
            ...
            else
            {
                ...
                {
                    curveParams = new X9ECParameters(emCastleProvider.CONFIGURATION.getEcImplicitlyCa().getCurve(), emCastleProvider.CONFIGURATION.getEcImplicitlyCa().getG(), emCastleProvider.CONFIGURATION.getEcImplicitlyCa().getN(), emCastleProvider.CONFIGURATION.getEcImplicitlyCa().getH());
                }
                else
                {
