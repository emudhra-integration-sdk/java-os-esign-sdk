 ...
 * {@link org.emcastle.x509.X509Store} SPI implementation for certificate
 * pairs.
 *
 * @see org.emcastle.x509.X509Store
 * @see org.emcastle.x509.X509CertificatePair
 */
public class X509StoreCertPairCollection extends X509StoreSpi
{
     ...
     * {@link org.emcastle.x509.X509CertificatePair}s. The selector must be
     * a {@link org.emcastle.x509.X509CertPairStoreSelector} to select
     * certificate pairs.
     *
