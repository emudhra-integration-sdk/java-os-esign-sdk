...
import org.emcastle.crypto.StreamBlockCipher;
import org.emcastle.crypto.StreamCipher;
import org.emcastle.crypto.engines.BlowfishEngine;
import org.emcastle.crypto.engines.DESEngine;
import org.emcastle.crypto.engines.DESedeEngine;
import org.emcastle.crypto.engines.SkipjackEngine;
import org.emcastle.crypto.engines.TwofishEngine;
    ...
    protected AlgorithmParameters engineGetParameters() 
    {
        if (engineParams == null)
        {
            if (pbeSpec != null)
            {
                try
                {
                    AlgorithmParameters engineParams = AlgorithmParameters.getInstance(pbeAlgorithm, emCastleProvider.PROVIDER_NAME);
         ...
         throws InvalidKeyException
     {
         ...
         else if (wrappedKeyAlgorithm.equals("") && wrappedKeyType == Cipher.PRIVATE_KEY)
         {
             ...
             try
             {
                 ...
                 PrivateKey privKey = emCastleProvider.getPrivateKey(in);
         ...
         else
         {
             try
             {
                 KeyFactory kf = KeyFactory.getInstance(wrappedKeyAlgorithm, emCastleProvider.PROVIDER_NAME);
