...
import org.emcastle.asn1.dvcs.DVCSObjectIdentifiers;
    ...
    extends DVCSMessage
{
        ...
        throws DVCSConstructionException
    {
        ...
        try
        {
            ...
            {
                this.asn1 = org.emcastle.asn1.dvcs.DVCSResponse.getInstance(contentInfo.getContent());
            }
            else
            {
                this.asn1 = org.emcastle.asn1.dvcs.DVCSResponse.getInstance(ASN1OctetString.getInstance(contentInfo.getContent()).getOctets());
            }
        }
        catch (Exception e)
        {
     ...
     *
     * @return an org.emcastle.asn1.dvcs.DVCSResponse object.
     */
